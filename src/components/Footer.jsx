...
const Footer = () => {
  return (
    <div id="Footer">
    <div className='flex   lg:flex-row flex-col gap-20 lg:gap-0 pt-5 '>
      <div className="flex flex-col px-10 lg:w-1/2 lg:px-30 justify-center gap-10 ">
        ...
        <div className="">
          <p className='text-[#FFFFFF] lg:text-[25px] font-Popins font-extralight  '>"Ready to bring your creative vision to life? Our team at The Unicorn Pictures is eager to hear from you. Whether you're seeking stunning photography, captivating animation, or have a unique project in mind, we're here to help.</p>
        </div>
      </div>
      <div className="flex flex-col text-[#FFFFFF] font-[Rubik] text-[10px] md:text-[20px] lg:text-[30px] justify-center px-10 lg:w-3/5 gap-10 overflow-hidden">
        <div className="flex flex-row md:gap-45 px-20 gap-15 items-center">
          <p>Ph no:</p>
          <p>+91 9620425828</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:gap-50 gap-8 lg:px-2 px-10 ">
          <p>Follow Us:</p>
