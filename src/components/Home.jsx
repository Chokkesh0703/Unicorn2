...
const Home = () => {
  return (
    <div className="flex  flex-col gap-10 lg:flex-row lg:gap-20  lg:w-full h-12/12 md:pt-0 lg:p-30 lg:pt-15   md:p-5 md:ml-20 lg:ml-0 p-1 overflow-hidden">
        ...
        <p className="text-[#FFFFFFCC] mr-10 md:text-[20px] md:mr-20 font-[Poppins,] font-extrabold lg:font-light">
        ...
        <button className="bg-[#D6B962] text-[#0E1320] flex  font-medium rounded-full w-16 h-6 justify-center items-center hover:bg-yellow-600 gap-2 md:w-32 md:h-9 md:gap-4 ">
            <span className=" text-[5px] ml-2 md:text-[15px] md:ml-2 font-light">Read More</span>
       ...
       <div
          className=" bg-no-repeat  bg-cover md:h-[700px] md:w-[700px]  lg:h-[700px] lg:w-[650px]   brightness-80 h-[500px] relative  "
        >
          <img src={sidepic} alt="" className="w-full h-full" />
            
            <div className="absolute bottom-6 p-10 md:p-20 md:bottom-0  xl:p-10 2xl:p-10 ">
              <h2 className="text-[35px] md:text-[40px] font-semibold  text-[#ffff] mb-2 ">
                8.2
              </h2>
