...
import sidepic2 from "./../assets/sidepic/sidepic2.jpeg";
...
const Home = () => {
  return (
    <div id="Home" className="flex  flex-col gap-10 lg:flex-row lg:gap-20  lg:w-full h-12/12 md:pt-0 lg:p-30 lg:pt-15   md:p-5 md:ml-20 lg:ml-0 p-1 overflow-hidden">
       ...
       <div
          className=" bg-no-repeat  bg-cover md:h-[700px] md:w-[700px]  lg:h-[700px] lg:w-[650px]  h-[500px] relative p-10 md:p-0 md:pl-15 lg:p-0 lg:pr-0"
        >
